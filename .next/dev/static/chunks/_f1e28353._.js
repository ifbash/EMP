...
function WeeklyTimesheet() {
    ...
    const [currentWeek, setCurrentWeek] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(todayWeek);
    ...
    const weekDays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WeeklyTimesheet.useMemo[weekDays]": ()=>Array.from({
                length: 7
            }).map({
                "WeeklyTimesheet.useMemo[weekDays]": (_, i)=>{
            ...
            }["WeeklyTimesheet.useMemo[weekDays]"])
    }["WeeklyTimesheet.useMemo[weekDays]"], [
        currentWeek
    ]);
    const openDay = (key)=>{
    ...
    const updateRow = (id, patch)=>{
        ...
        setEntries((p)=>({
                ...p,
                [selectedDate]: {
                    rows: p[selectedDate].rows.map((r)=>r.id === id ? {
                            ...r,
                            ...patch
                        } : r)
                }
    ...
    const removeRow = (id)=>{
        ...
        setEntries((p)=>({
                ...p,
                [selectedDate]: {
                    rows: p[selectedDate].rows.filter((r)=>r.id !== id)
                }
            }));
    };
    const submitTimesheet = ()=>setStatus("SUBMITTED");
    const canGoNext = currentWeek < todayWeek;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
              ...
              ${status === "DRAFT" ? "bg-gray-200 text-gray-700" : status === "SUBMITTED" ? "bg-blue-100 text-blue-700" : status === "APPROVED" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`,
                                children: status
                            }, void 0, false, {
                                fileName: "[project]/src/app/(admin)/(others-pages)/timesheet/page.tsx",
                                lineNumber: 130,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: weekDays.map((d)=>{
                    const day = entries[d.key];
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        onClick: ()=>openDay(d.key),
                        className: `rounded-xl border p-4 text-center cursor-pointer hover:shadow ${!isEditable && "opacity-60 cursor-not-allowed"}`,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-sm",
                            ...
                            day?.rows.map((r)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: `block mt-1 text-xs rounded px-2 py-0.5 ${STATUS_COLOR[r.status]}`,
                                    children: [
                                        r.project,
                                        " – ",
                                        r.status
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$modal$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Modal"], {
                ...
                children: selectedDate && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        entries[selectedDate]?.rows.map((r)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: addRow,
                            className: "flex gap-2 text-blue-600 text-sm",
                            children: [
...
_s(WeeklyTimesheet, "dmgxIRppauUNVrfcbD6SnxVSVuk=");
_c1 = WeeklyTimesheet;
var _c, _c1;
__turbopack_context__.k.register(_c, "EMPTY_ROW");
__turbopack_context__.k.register(_c1, "WeeklyTimesheet");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_f1e28353._.js.map