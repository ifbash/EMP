...
;
;
/* ================= CONSTANTS ================= */ const leaveEventColors = {
    "Sick Leave": "danger",
    "Planned Leave": "primary",
    "Optional Holiday": "warning",
    "Work from Home": "success"
};
/* ================= DATE HELPERS ================= */ const addOneDay = (date)=>{
...
function LeaveCalendarPage() {
    ...
    /* ================= VALIDATION ================= */ const validateForm = ()=>{
        const e = {};
        if (!leaveType) e.leaveType = true;
        if (!startDate) e.startDate = true;
        if (!endDate) e.endDate = true;
        setErrors(e);
        return Object.keys(e).length === 0;
    };
    /* ================= HANDLERS ================= */ const handleDateSelect = (info)=>{
        resetForm();
        setStartDate(info.startStr);
        setEndDate(info.startStr);
        openModal();
    };
    const handleEventClick = (info)=>{
        const evt = info.event;
        const start = evt.startStr;
        let end = start;
        if (evt.end) {
            end = subtractOneDay(evt.end);
        }
    ...
    const handleSave = ()=>{
        ...
        if (selectedEvent) {
            setEvents((prev)=>prev.map((e)=>e.id === selectedEvent.id ? {
                        ...
                        allDay: true,
                        extendedProps: {
                            calendar: leaveEventColors[leaveType],
                            leaveType,
                            reason
                        }
                    } : e));
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$modal$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Modal"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        ...
                        children: selectedEvent ? "Edit Leave" : "Apply Leave"
                    }, void 0, false, {
                        fileName: "[project]/src/app/(admin)/(others-pages)/leave-calendar/page.tsx",
                        lineNumber: 188,
                        columnNumber: 17
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                className: `mt-1 w-full rounded-lg border px-3 py-2 ${errors.leaveType ? "border-red-500" : "border-gray-300"}`,
                                children: [
                                    ...
                                    Object.keys(leaveEventColors).map((type)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            children: type
                                        }, type, false, {
                                            fileName: "[project]/src/app/(admin)/(others-pages)/leave-calendar/page.tsx",
                                            lineNumber: 203,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: selectedEvent ? "Update Leave" : "Apply Leave"
                            }, void 0, false, {
                                fileName: "[project]/src/app/(admin)/(others-pages)/leave-calendar/page.tsx",
                                lineNumber: 251,
                                columnNumber: 21
...
_s(LeaveCalendarPage, "6dIL5/QfShNf4z6CKL+XVteBaa4=", false, function() {
    return [
...
_c = LeaveCalendarPage;
/* ================= EVENT UI ================= */ const renderEventContent = (info)=>{
    const color = info.event.extendedProps.calendar;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `event-fc-color fc-bg-${color} rounded-md px-2 py-1 text-xs font-medium text-white`,
...
var _c;
__turbopack_context__.k.register(_c, "LeaveCalendarPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_168964f0._.js.map