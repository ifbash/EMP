...
function PayslipsPage() {
    ...
    const handleDownloadPDF = ()=>{
        ...
        doc.setFontSize(12);
        let y = 25;
        doc.text(`Employee Name: ${selectedPayslip.employeeName}`, 20, y);
        y += 7;
        doc.text(`Employee ID: ${selectedPayslip.employeeId}`, 20, y);
        y += 7;
        doc.text(`Date of Joining: ${selectedPayslip.dateOfJoining}`, 20, y);
        y += 7;
        doc.text(`Location: ${selectedPayslip.location}`, 20, y);
        y += 7;
        doc.text(`Payable Days: ${selectedPayslip.payableDays}`, 20, y);
        y += 7;
        doc.text(`LOP Days: ${selectedPayslip.lopDays}`, 20, y);
        y += 7;
        doc.text(`PAN: ${selectedPayslip.pan}`, 20, y);
        y += 7;
        doc.text(`UAN: ${selectedPayslip.uan}`, 20, y);
        y += 7;
        doc.text(`PF Number: ${selectedPayslip.pfNumber}`, 20, y);
        y += 7;
        doc.text(`ESIC Number: ${selectedPayslip.esicNumber}`, 20, y);
        y += 10;
        doc.text(`Bank Name: ${selectedPayslip.bankName}`, 20, y);
        y += 7;
        doc.text(`Account Number: ${selectedPayslip.accountNumber}`, 20, y);
        y += 10;
        doc.text("Earnings", 20, y);
        selectedPayslip.earnings.forEach((item)=>{
            y += 7;
            doc.text(`${item.label}: $${item.amount.toFixed(2)}`, 25, y);
        });
        y += 10;
        ...
        y += 15;
        doc.text("This payslip is computer generated and does not require any signature.", 20, y);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$modal$2f$index$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Modal"], {
                        ...
                        children: selectedPayslip && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "grid grid-cols-2 gap-4 border p-4 rounded-lg bg-gray-50 dark:bg-gray-800",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0bae4da9._.js.map